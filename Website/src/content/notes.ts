...
const curriculum: { id: number; year: string; label: string; courses: CourseInfo[] }[] = [
  ...
  { id: 6, year: 'Year III', label: 'Semester VI', courses: [course('CMP 362', 'Image Processing & Pattern Recognition', 3, '▧'), course('CMP 364', 'Machine Learning', 2, 'ML'), course('CMP 344', 'Computer Networks', 3, '↯'), course('CMP 338', 'Simulation & Modeling', 2, '◌', 'Simulation and Modeling'), course('CMP 422', 'Compiler Design', 3, '⌘', 'Compiler Design'), course('ELEC I', 'Elective I', 3, '＋'), course('PRJ 360', 'Project I', 2, '↗')] },
  { id: 7, year: 'Year IV', label: 'Semester VII', courses: [course('MGT 332', 'Entrepreneurship & Professional Practice', 2, '↗'), course('MGT 290', 'Engineering Economics', 3, '₨'), course('CMP 426', 'Network & Cyber Security', 3, '⌁'), course('CMP 424', 'Cloud Computing & Virtualization', 2, '☁'), course('CMP 360', 'Data Science & Analytics', 2, 'DS'), course('ELEC II', 'Elective II', 3, '＋')] },
